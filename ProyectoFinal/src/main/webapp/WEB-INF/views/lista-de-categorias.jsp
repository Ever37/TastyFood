...
<body>
			...
			<div class="container">
					...
					<div class="col s12">
						<div class="material-table">
							<div class="table-header">
								<span class="table-title">Listado de categorías </span>
								<div class="actions">
									<a href="#"
										class="search-toggle waves-effect btn-flat nopadding"><i
										class="material-icons">search</i></a> &nbsp; <a
										href="<c:url value='categorias-new' />" id="addCategoria"
									...
									<c:forEach items="${categorias}" var="cat">
										<tr>
											...
											<td><sec:authorize
													...
													<a id="enlace"
														href="<c:url value='/categorias-${cat.idCategoria}-view' />"
				...
				<c:if test="${categorias.size()==0}">
					<div style="text-align: center">
						<p style="color: red; font: bold;">No existen categorias
							cargadas</p>
					</div>
				</c:if>
				<br>
  ...
  function eliminar(categoria, id) {
	...
	swal({
	  title: 'Estás seguro?',
	  text: "La categoría '" + categoria + "' será eliminada",
	  type: 'warning',
  ...
  function(isConfirm){
		  if (isConfirm) {
				...
				var pos = URLactual.indexOf("categorias-listado");
				URLactual = URLactual.substring(pos, 0);
			  	window.location.href = URLactual + 'categorias-' + id +'-delete';
		  } 
	});
