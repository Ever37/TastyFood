...
<body>
	...
	<div class="section no-pad-bot" id="index-banner">
		...
		<div class="white">
			...
			<div class="container">
				<h5 class="flow-text">
					<i class="material-icons">remove_red_eye</i>&nbsp;&nbsp;Detalles del grupo
				</h5>
				<form:form class="col s12" id="frmc" method="POST"
					...
					<div class="row">
						...
						<div class="input-field col s6">
							<form:input path="descripcion" id="grupo" name="grupo"
																...
																<td>
																	<div align="center">
																		<form:radiobutton path="rComunes[${i.index}].permiso"
																			disabled="true" name="grupo${i.index}"
																			class="with-gap"
																...
																<td>
																	<div align="center">
																		<form:radiobutton
																			path="rEspeciales[${i.index}].permiso"
																			disabled="true" name="grupo${i.index}"
																			class="with-gap" id="permisoE${p.idPermiso}-${k}"
																			value="${p.idPermiso}" checked="checked" />
																		<label for="permisoE${p.idPermiso}-${k}"></label>
																	</div>
																</td>
