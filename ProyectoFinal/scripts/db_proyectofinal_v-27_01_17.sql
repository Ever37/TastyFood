...
CREATE TABLE `comercio` (
  ...
  `realiza_envios` int(1) DEFAULT NULL,
  `tiempo_envio_min` varchar(2) DEFAULT NULL,
  `tiempo_envio_max` varchar(2) DEFAULT NULL,
  ...
  `valoracion_total` double DEFAULT '0',
  `estado` varchar(1) DEFAULT NULL,
  PRIMARY KEY (`id_comercio`),
  UNIQUE KEY `descripcion_UNIQUE` (`descripcion`),
  KEY `fk_comercio_horario_idx` (`horario`),
  KEY `fk_comercio_usuario_idx` (`id_usuario`),
  CONSTRAINT `fk_comercio_horario` FOREIGN KEY (`horario`) REFERENCES `horario` (`id_horario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_comercio_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `comercio` VALUES (1,'Don Corleone','España ','1111',NULL,NULL,NULL,1,'15',NULL,30,'2017-01-09 03:00:00.000000',NULL,NULL,1,0,''),(2,'Luiggi','Bulevar Villada','1234',NULL,NULL,NULL,1,'30',NULL,15,'2017-01-09 12:11:32.016008',NULL,NULL,2,0,''),(3,'Cocina Artesanal','Lavalle ','4535',NULL,NULL,NULL,1,'45',NULL,20,'2017-01-09 12:11:32.016006',NULL,NULL,3,0,''),(4,'Artes gourmet','España ','2313',NULL,NULL,NULL,1,'30',NULL,30,'2017-01-12 11:37:03.536232',NULL,NULL,4,0,''),(5,'mmm','uytguyt','1356','','','897984616',NULL,'15','35',NULL,'2017-01-26 15:43:33.383109',NULL,NULL,3,NULL,NULL);
...
INSERT INTO `grupo` VALUES (1,'Administrador'),(3,'Cliente'),(4,'Vendedor');
...
CREATE TABLE `horario` (
  ...
  `hora_desde` time(4) DEFAULT NULL,
  `hora_hasta` time(4) DEFAULT NULL,
...
INSERT INTO `requerimiento_permiso` VALUES (1,'ADMIN',1,3),(2,'ADMIN',1,2),(3,'ADMIN',1,1),(4,'ADMIN',1,4);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci PACK_KEYS=0;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `requerimiento_permiso_grupo` VALUES (1,1,1),(2,4,1);
...
CREATE TABLE `usuario` (
  ...
  KEY `fk_usuario_comercio_idx` (`id_comercio`),
  CONSTRAINT `fk_usuario_comercio` FOREIGN KEY (`id_comercio`) REFERENCES `comercio` (`id_comercio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `usuario` VALUES (1,'Ever.B','12345678','Ever','Blua','34646698661','','everblua@gmail.com',0,NULL,'S',1,1,'2017-01-11 12:23:37.106037'),(2,'Juan.P','a5s5d4as8d','Juan','Perez','165498498','6478797','juan@gmail.com',0,NULL,'S',1,2,'2017-01-11 12:23:37.106037'),(3,'Rojas','45ads78','Maria','Rojas','','1123123','rojas@gmail.com',0,NULL,'N',1,3,'2017-01-11 12:23:37.000000'),(4,'Caiga','wwww','Carlos','Caifa','56412637','971297','caifa@gmail.com',0,NULL,'N',1,4,'2017-01-12 11:36:27.000000'),(8,'Luiggi','564123641','Juan','Perez','324864','654654','juanperez@gmail.com',0,'2017-01-24','S',4,NULL,'2017-01-24 02:37:57.000000'),(9,'LaChacha','564123641','Juan','Perez','324864','654654','juanperez@gmail.com',0,'2017-01-24','S',4,NULL,'2017-01-24 02:39:30.000000'),(10,'Pepita','564123641','Juan','Perez','324864','654654','juanperez@gmail.com',0,'2017-01-24','S',4,NULL,'2017-01-24 02:39:56.000000');
...
-- Dump completed on 2017-01-26 12:49:43
